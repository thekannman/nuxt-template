  ...
  <div class="w-full">
        ...
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          ...
          >
            ...
            >
              ...
              <Icon size="20" name="mdi:chevron-down" class="mt-1 text-[#0c66ee]"/>
            </BaseButton>
          </div>
        </div>
    ...
    <section class="w-full my-36">
      <BaseSection data-aos="fade-down">
        <div class="col-span-12 lg:col-span-7">
          <div class="w-full">
            <NuxtImg src="/img/nefa-cc.webp" class="w-[95%]" alt="" />
          </div>
        </div>
    ...
    <section class="w-full my-24">
      <div class="relative max-w-screen-xl px-8 mx-auto grid grid-cols-12 gap-x-6">
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <NuxtImg src="/img/industry-leading-security.webp" class="w-full" alt="" />
          </div>
        </div>
    ...
    <section class="w-full my-24">
      <BaseSection>
        <div data-aos="fade-right" data-aos-delay="150" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <NuxtImg src="/img/faq.webp" class="w-full" alt="" />
          </div>
        </div>
    ...
    <div class="w-full my-10 flex justify-center">
      ...
      >
        ...
        <Icon size="20" name="mdi:arrow-up" />
      </NuxtLink>
    </div>
  </div>
</template>
